#
#  Incase you're still checking this far. Yesss I know this code doesnt run on itself it needs values / test runs, bc its only an authenticator theres no main function.
#
...
class User:
    ...
    def check_privileges(self, required_level):
        ...
        return privilege_hierarchy.get(self.__privilege_level, 0) >= \
