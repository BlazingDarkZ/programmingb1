...
WEATHER_CODES = {
    ...
    95: "Thunderstorm", 96: "Thunderstorm (slight hail)", 97: "Thunderstorm (heavy hail)"
}
...
def collect_eu_weather_data(delay_seconds: int = 1) -> Dict:
    ...
    for i, cap in enumerate(EU_CAPITALS):
        city, country = cap["city"], cap["country"]
...
def main():
    ...
    temps = [d["current_weather"]["temperature"] for d in all_data.values() if d["current_weather"]["temperature"] is not None]
